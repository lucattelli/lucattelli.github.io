...
S.prototype._executeWithElement=function(o){o=g(o);var h=this.getAction();if(!h){var i=o;var j=this.getMovedElements();if(j.length>1){q.sap.log.warning("Moving more than 1 Formelement is not yet supported.");}var t=this.getTarget();if(j[0].element instanceof sap.ui.layout.form.FormContainer){h=f(i,j[0],t);}else if(j[0].element instanceof sap.ui.layout.form.FormElement){h=b(i,j[0],t);}this.setAction(h);var R=q.extend(true,{},h);R.source.elements=G(sap.ui.getCore().byId(h.target.parent),h);this._setReverseAction(R);}if(h){d(h);}};
S.prototype._undoWithElement=function(o){s(this);this._executeWithElement(o);};
var g=function(o){if(E.isInstanceOf(o,"sap.ui.layout.form.SimpleForm")){return o;}else if(E.isInstanceOf(o,"sap.ui.layout.form.Form")||E.isInstanceOf(o,"sap.ui.layout.form.FormContainer")||E.isInstanceOf(o,"sap.ui.layout.form.FormElement")){return g(o.getParent());}};var m=function(t,C,h){var R;var j=-1;for(var i=0;i<C.length;i++){if(C[i]instanceof t){j++;if(j===h){R=C[i];break;}}}return C.indexOf(R);};var M=function(F){var h=F.getFormElements();var i=h.reduce(function(p,j,k,l){p+=j.getFields().length+1;return p;},1);return i;};var e=function(C){var R=[];for(var i=0;i<C.length;i++){R.push(C[i].getId());}return R;};var a=function(h,j,t,T,k){var R=t;for(var i=0;i<k;i++){R.splice(T+i,0,h[j+i]);}return R;};var c=function(p,h){return{changeType:'reorder_aggregation',source:{elements:h},target:{parent:p,aggregation:'content'}};};var f=function(o,h,t){var C=o.getContent();var i=h.element.getTitle();var j=C.indexOf(i);var T=m(sap.ui.core.Title,C,h.targetIndex);var k=M(h.element);var l=C.slice();l.splice(j,k);l=a(C,j,l,T,k);return c(o.getId(),e(l));};var b=function(o,h,t){var C=o.getContent();var F=t.parent.getFormElements();var i=C.indexOf(h.element.getLabel());var j=F[h.targetIndex].getFields().length+1;var T=C.indexOf(t.parent.getTitle());if(T>i){T=T-j;}var O=0;for(var k=0;k<h.targetIndex;k++){O=O+F[k].getFields().length+1;}T=T+O+1;var l=C.slice();l.splice(i,j);l=a(C,i,l,T,j);return c(o.getId(),e(l));};var G=function(t,o){var h=E.getAggregationAccessors(t,o.target.aggregation).get;return e(t[h]());};var r=function(t,o){var h=E.getAggregationAccessors(t,o.target.aggregation).removeAll;t[h]();};var A=function(t,o){var h=E.getAggregationAccessors(t,o.target.aggregation).add;var i;for(var j=0;j<o.source.elements.length;j++){i=sap.ui.getCore().byId(o.source.elements[j]);t[h](i);}};var d=function(o){var t=sap.ui.getCore().byId(o.target.parent);r(t,o);A(t,o);};var s=function(C){var t=C._getReverseAction();C._setReverseAction(C.getAction());C.setAction(t);};return S;},true);
...
b.prototype.buildMoveEvent=function(){var m=this.getMovedOverlay();var o=m.getElementInstance();var s=this._getSource();var p=s.publicParent;var S=a.getOverlay(p);var t=O.getParentInformation(m);var i=s.index;var T=t.index;var c=this._compareSourceAndTarget(s,t);if(c){return undefined;}delete s.index;delete t.index;var d=this.getCommandFactory().getCommandFor(p,"Move",{movedElements:[{element:o,sourceIndex:i,targetIndex:T}],source:s,target:t},S.getDesignTimeMetadata());if(d){if(d.getMetadata().getName()==="sap.ui.dt.command.SimpleFormMove"){d.execute();}}else{jQuery.sap.log.error("Invalid move action in design time metadata of "+s.parent.getMetadata().getName());}return d;};
...
A.prototype.getMoveAction=function(m){var d=this.getData();if(d.actions&&d.actions.move){var M=d.actions.move;if(typeof(M)==="function"){return M.apply(null,arguments);}else{return M;}}else{return undefined;}};
return A;},true);
...
A.prototype.getAssociatedDomRef=function(){var e=this.getElementInstance();var a=this.getAggregationName();var d=this.getDesignTimeMetadata();var D=d.getDomRef();var v=d.getAssociatedDomRef(e,D,a);return v;};
...
a.prototype.getAssociatedDomRef=function(e,d,A){var o=E.getDomRef(e);var b=[];b.push(e);if(A){b.push(A);}if(typeof(d)==="function"){return d.apply(null,b);}else if(o&&typeof(d)==="string"){return D.getDomRefForCSSSelector(o,d).get(0);}return undefined;};
...
E.prototype.getAggregationDescription=function(a,e){var c=this.getAggregation(a).childrenName;if(typeof c==="function"){c=c.call(null,e);}if(c){return{singular:this._getText(c.singular),plural:this._getText(c.plural)};}};
...
e.prototype._createAggregationOverlays=function(){var t=this;this._mAggregationOverlays={};var o=this.getElementInstance();var f=this.getDesignTimeMetadata();var m={};c.iterateOverAllPublicAggregations(o,function(i,j){var s=i.name;m[s]=true;t._createAggregationOverlay(s,t.isInHiddenTree());});var g=f.getAggregations();var h=Object.keys(g);h.forEach(function(s){var i=g[s];if(i.ignore===false&&!m[s]){var I=i.inHiddenTree;t._createAggregationOverlay(s,I);}});this.sync();};
...
E.findAllSiblingsInContainer=function(e,c){var p=e.getParent();if(p!==c){var P=E.findAllSiblingsInContainer(p,c);return P.map(function(p){return E.getAggregation(p,e.sParentAggregationName);}).reduce(function(a,b){return a.concat(b);},[]);}return E.getAggregation(p,e.sParentAggregationName);};
...
var P=M.extend("sap.ui.dt.Plugin",{metadata:{"abstract":true,library:"sap.ui.dt",properties:{designTime:{type:"object",multiple:false},commandFactory:{type:"object",multiple:false}},associations:{},events:{elementModified:{command:{type:"sap.ui.dt.command.BaseCommand"}}}}});
...
a.prototype.showGhost=function(o,e){var t=this;if(!sap.ui.Device.browser.internet_explorer&&!sap.ui.Device.browser.edge&&!sap.ui.Device.browser.msie&&e&&e.originalEvent&&e.originalEvent.dataTransfer&&e.originalEvent.dataTransfer.setDragImage){this._$ghost=this.createGhost(o,e);this._$ghost.appendTo("#overlay-container");setTimeout(function(){t._removeGhost();},0);e.originalEvent.dataTransfer.setDragImage(this._$ghost.get(0),e.originalEvent.pageX-o.$().offset().left,e.originalEvent.pageY-o.$().offset().top);}};
...
a.prototype._onAggregationDrop=function(e){var A=sap.ui.getCore().byId(e.currentTarget.id);this.onAggregationDrop(A,e);e.preventDefault();e.stopPropagation();};
